    ...
    <div className="space-y-6">
      ...
      <div className="card space-y-5">
        <div>
          ...
          <p className="mt-1 max-w-lg text-[14px] leading-relaxed text-content-secondary">
            Upload identity and income docs. Extraction, KYC, and cross-checks
            run on the live LOS API.
          </p>
        </div>
        ...
        >
          ...
          <svg
            className="h-3 w-3 text-content-disabled"
            viewBox="0 0 12 12"
            fill="none"
            aria-hidden="true"
          >
      ...
      <form onSubmit={submit} className="space-y-4" noValidate>
        ...
        {issues.length > 0 && (
          ...
          >
            <p className="mb-1 text-[13px] font-semibold text-warning-text">
              Check these files
            </p>
        ...
        <p className="pt-1 text-center font-sans text-[12px] text-content-secondary">
          Responses come only from your live API · no mock data
        </p>
      </form>
    </div>
  );
